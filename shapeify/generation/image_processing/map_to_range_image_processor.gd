class_name MapToRangeImageProcessor extends ImageProcessor

var min_bound: float = 0.0
var max_bound: float = 1.0
...
func _init() -> void:
	...
	# Create our _shader.
	var shader_file := load("res://shaders/compute/image_processing/map_to_range.glsl")
