...
static func factory_create(type: Type) -> SurvivorSelectionStrategy:
	match type:
		SurvivorSelectionStrategy.Type.KEEP_CHILDREN:
			return load("res://generation/image_generation/shape_generator/genetic/survivor_selection/keep_children_survivor_selection_strategy.gd").new()
		SurvivorSelectionStrategy.Type.ELITISM:
			return load("res://generation/image_generation/shape_generator/genetic/survivor_selection/elitism_survivor_selection_strategy.gd").new()
		SurvivorSelectionStrategy.Type.TOURNAMENT:
			return load("res://generation/image_generation/shape_generator/genetic/survivor_selection/tournament_survivor_selection_strategy.gd").new()
		_:
