...
static func factory_create(type: Type) -> SelectionStrategy:
	match type:
		SelectionStrategy.Type.Ranking:
			return load("res://generation/image_generation/shape_generator/genetic/selection/ranking_selection_strategy.gd").new()
			
		SelectionStrategy.Type.FitnessProportionate:
			return load("res://generation/image_generation/shape_generator/genetic/selection/fitness_proportionate_selection_strategy.gd").new()
			
		SelectionStrategy.Type.Uniform:
			return load("res://generation/image_generation/shape_generator/genetic/selection/uniform_selection_strategy.gd").new()
		_:
